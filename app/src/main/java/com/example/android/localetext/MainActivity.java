...
public class MainActivity extends AppCompatActivity {
    ...
    private NumberFormat mCurrenyFormat=NumberFormat.getCurrencyInstance();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(deviceLocale.equals("ID")){
            ...
            myFormattedPrice=mCurrenyFormat.format(mPrice);
        }else {
            mCurrenyFormat=NumberFormat.getCurrencyInstance(Locale.US);
            myFormattedPrice=mCurrenyFormat.format(mPrice);
        }
                ...
                if (actionId == EditorInfo.IME_ACTION_DONE) {
                    ...
                    if (v.toString().equals("")) {
                        ...
                        try {
                            ...
                            String myFormattedTotalPrice=mCurrenyFormat.format(total);
